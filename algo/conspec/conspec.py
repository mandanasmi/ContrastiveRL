...
from algo.conspec.storage_conspec import RolloutStorage
from algo.conspec.prototype import ConSpecPrototype as prototypes
from algo.conspec.model_conspec import EncoderConSpec
...
class ConSpec(nn.Module):
    ...
    def calc_intrinsic_reward(self):
        ...
        with torch.no_grad():
            ...
            #print('cos score after reshape:', cos_scores.shape) # torch.Size([125, 16, 8])
