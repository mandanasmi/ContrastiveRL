...
class PlayerSprite(common.PlayerSprite):
  ...
  def update(self, actions, board, layers, backdrop, things, the_plot):
    ...
    if (common.DOOR in self.impassable and the_plot.get('has_key')) or ( common.DOOR in self.impassable and the_plot.get('has_key2')):
...
class Game(game.AbstractGame):
  ...
  def __init__(self,
               ...
               final_reward=10.,
               crop=True,
               max_frames=common.DEFAULT_MAX_FRAMES_PER_PHASElong2keys):
